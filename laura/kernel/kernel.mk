...
KOBJS := assert.o main.o raise.o S_Handler.o I_Handler.o read.o write.o exit.o sleep.o time.o load_user_prog.o init_irq.o C_IRQ_Handler.o C_SWI_Handler.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
